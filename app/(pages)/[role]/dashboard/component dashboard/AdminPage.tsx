    ...
    <section>
      ...
      <div className="w-screen px-8">
        ...
        <div className="flex w-full justify-between mb-6">
          ...
          <button className="btn btn-outline font-semibold text-[16px] hover:bg-[#023E8A]">
            Download Recap
          </button>
        </div>
        {/*  */}
        ...
        <div className="flex w-full justify-between mt-6">
          ...
          <button className="btn btn-outline font-semibold text-[24px] px-16 h-[98px] hover:bg-[#023E8A]">
            Enter class
          </button>
        </div>
